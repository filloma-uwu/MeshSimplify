...
| Metric | Value |
|---|---:|
| Original pool build ms |2493.948300|
| Official simplified pool build ms |394.125100|
| Reference import ms |61.337700|
| Analyzed primitive BVH build ms |95.950700|
| Primitive BVH cache hits |13|
| Primitive BVH cache misses |0|
| Primitive BVH cache load ms |4.652300|
| Primitive BVH uncached build ms |0.000000|
| Primitive BVH cache save ms |0.000000|
| Install into PQSS ModelPool ms |5.648300|
...
| Parallel query wall ms |95.672900|98.897500|89.420400|
