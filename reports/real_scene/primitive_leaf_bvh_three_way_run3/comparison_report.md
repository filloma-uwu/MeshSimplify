...
| Metric | Value |
|---|---:|
| Original pool build ms |2495.923800|
| Official simplified pool build ms |394.545700|
| Reference import ms |65.239200|
| Analyzed primitive BVH build ms |97.293500|
| Primitive BVH cache hits |13|
| Primitive BVH cache misses |0|
| Primitive BVH cache load ms |4.731600|
| Primitive BVH uncached build ms |0.000000|
| Primitive BVH cache save ms |0.000000|
| Install into PQSS ModelPool ms |5.422800|
