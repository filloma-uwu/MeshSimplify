...
| Metric | Value |
|---|---:|
| Original pool build ms |2405.318500|
| Official simplified pool build ms |379.627600|
| Reference import ms |55.765100|
| Analyzed primitive BVH build ms |68.027500|
| Primitive BVH cache hits |13|
| Primitive BVH cache misses |0|
| Primitive BVH cache load ms |1.510900|
| Primitive BVH uncached build ms |0.000000|
| Primitive BVH cache save ms |0.000000|
| Install into PQSS ModelPool ms |4.669400|
...
| Parallel query wall ms |96.189700|90.007400|88.917400|
