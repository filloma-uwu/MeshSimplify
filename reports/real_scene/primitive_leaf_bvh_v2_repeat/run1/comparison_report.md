...
| Metric | Value |
|---|---:|
| Original pool build ms |2402.740100|
| Official simplified pool build ms |375.780000|
| Reference import ms |58.178200|
| Analyzed primitive BVH build ms |68.766500|
| Primitive BVH cache hits |13|
| Primitive BVH cache misses |0|
| Primitive BVH cache load ms |1.486200|
| Primitive BVH uncached build ms |0.000000|
| Primitive BVH cache save ms |0.000000|
| Install into PQSS ModelPool ms |4.706400|
...
| Parallel query wall ms |96.278400|91.275400|87.394900|
