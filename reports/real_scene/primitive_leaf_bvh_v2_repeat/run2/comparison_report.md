...
| Metric | Value |
|---|---:|
| Original pool build ms |2409.098700|
| Official simplified pool build ms |379.556100|
| Reference import ms |56.612100|
| Analyzed primitive BVH build ms |66.955800|
| Primitive BVH cache hits |13|
| Primitive BVH cache misses |0|
| Primitive BVH cache load ms |1.421100|
| Primitive BVH uncached build ms |0.000000|
| Primitive BVH cache save ms |0.000000|
| Install into PQSS ModelPool ms |4.719900|
...
| Parallel query wall ms |98.879500|96.744800|88.980500|
