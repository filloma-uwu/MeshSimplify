...
| Metric | Value |
|---|---:|
| Original pool build ms |2421.811700|
| Official simplified pool build ms |380.123400|
| Reference import ms |61.126100|
| Analyzed primitive BVH build ms |69.304800|
| Primitive BVH cache hits |13|
| Primitive BVH cache misses |0|
| Primitive BVH cache load ms |1.484200|
| Primitive BVH uncached build ms |0.000000|
| Primitive BVH cache save ms |0.000000|
| Install into PQSS ModelPool ms |4.908700|
...
| Parallel query wall ms |93.835400|94.702900|88.610100|
