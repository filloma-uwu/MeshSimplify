...
| Metric | Value |
|---|---:|
| Original pool build ms |2505.635500|
| Official simplified pool build ms |390.688300|
| Reference import ms |62.446000|
| Analyzed primitive BVH build ms |96.854100|
| Primitive BVH cache hits |13|
| Primitive BVH cache misses |0|
| Primitive BVH cache load ms |4.645800|
| Primitive BVH uncached build ms |0.000000|
| Primitive BVH cache save ms |0.000000|
| Install into PQSS ModelPool ms |5.257100|
...
| Parallel query wall ms |96.982500|96.221200|89.188200|
