...
| Metric | Value |
|---|---:|
| Original pool build ms |2482.936300|
| Official simplified pool build ms |393.256100|
| Reference import ms |64.966600|
| Analyzed primitive BVH build ms |96.229200|
| Primitive BVH cache hits |13|
| Primitive BVH cache misses |0|
| Primitive BVH cache load ms |4.592100|
| Primitive BVH uncached build ms |0.000000|
| Primitive BVH cache save ms |0.000000|
| Install into PQSS ModelPool ms |5.336800|
...
| Parallel query wall ms |96.156800|94.680300|89.610100|
