...
| Metric | Value |
|---|---:|
| Reference pool build ms |2431.802200|
| Reference import ms |63.539400|
| Analyzed primitive BVH build ms |96.093200|
| Primitive BVH cache hits |13|
| Primitive BVH cache misses |0|
| Primitive BVH cache load ms |4.368800|
| Primitive BVH uncached build ms |0.000000|
| Primitive BVH cache save ms |0.000000|
| Install into PQSS ModelPool ms |5.097700|
...
| Positives |1881|1975|
| Parallel query wall ms |95.878900|89.375200|
