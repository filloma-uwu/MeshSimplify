...
| Metric | Value |
|---|---:|
| Original pool build ms |2416.242700|
| Official simplified pool build ms |378.761800|
| Reference import ms |59.324600|
| Analyzed primitive BVH build ms |73.386400|
| Primitive BVH cache hits |13|
| Primitive BVH cache misses |0|
| Primitive BVH cache load ms |1.654100|
| Primitive BVH uncached build ms |0.000000|
| Primitive BVH cache save ms |0.000000|
| Install into PQSS ModelPool ms |5.064600|
...
| Parallel query wall ms |94.777700|92.615600|86.795500|
