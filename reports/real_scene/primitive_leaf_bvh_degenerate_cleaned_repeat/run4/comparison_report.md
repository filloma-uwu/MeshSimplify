...
| Metric | Value |
|---|---:|
| Original pool build ms |2419.237900|
| Official simplified pool build ms |374.994400|
| Reference import ms |60.497400|
| Analyzed primitive BVH build ms |72.062200|
| Primitive BVH cache hits |13|
| Primitive BVH cache misses |0|
| Primitive BVH cache load ms |1.462700|
| Primitive BVH uncached build ms |0.000000|
| Primitive BVH cache save ms |0.000000|
| Install into PQSS ModelPool ms |4.634900|
...
| Parallel query wall ms |93.293600|95.221100|86.954100|
