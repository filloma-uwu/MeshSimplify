...
| Metric | Value |
|---|---:|
| Original pool build ms |2432.120500|
| Official simplified pool build ms |378.660800|
| Reference import ms |59.953200|
| Analyzed primitive BVH build ms |71.223900|
| Primitive BVH cache hits |13|
| Primitive BVH cache misses |0|
| Primitive BVH cache load ms |1.439000|
| Primitive BVH uncached build ms |0.000000|
| Primitive BVH cache save ms |0.000000|
| Install into PQSS ModelPool ms |5.151500|
...
| Parallel query wall ms |92.812500|91.790500|88.697600|
