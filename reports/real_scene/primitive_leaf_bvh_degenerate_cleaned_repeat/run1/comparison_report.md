...
| Metric | Value |
|---|---:|
| Original pool build ms |2402.213800|
| Official simplified pool build ms |375.932800|
| Reference import ms |60.143100|
| Analyzed primitive BVH build ms |71.842800|
| Primitive BVH cache hits |13|
| Primitive BVH cache misses |0|
| Primitive BVH cache load ms |1.525500|
| Primitive BVH uncached build ms |0.000000|
| Primitive BVH cache save ms |0.000000|
| Install into PQSS ModelPool ms |4.633900|
...
| Parallel query wall ms |95.360500|91.398500|86.615300|
