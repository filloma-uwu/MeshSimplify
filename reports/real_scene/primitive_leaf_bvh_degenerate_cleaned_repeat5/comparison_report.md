...
| Metric | Value |
|---|---:|
| Original pool build ms |2391.889500|
| Official simplified pool build ms |379.402300|
| Reference import ms |59.985500|
| Analyzed primitive BVH build ms |73.129400|
| Primitive BVH cache hits |13|
| Primitive BVH cache misses |0|
| Primitive BVH cache load ms |1.529800|
| Primitive BVH uncached build ms |0.000000|
| Primitive BVH cache save ms |0.000000|
| Install into PQSS ModelPool ms |4.721900|
...
| Parallel query wall ms |23.626700|24.566900|19.969700|
