...
| Metric | Value |
|---|---:|
| Reference pool build ms |2439.426300|
| Reference import ms |66.314600|
| Analyzed primitive BVH build ms |94.504000|
| Primitive BVH cache hits |13|
| Primitive BVH cache misses |0|
| Primitive BVH cache load ms |4.370900|
| Primitive BVH uncached build ms |0.000000|
| Primitive BVH cache save ms |0.000000|
| Install into PQSS ModelPool ms |5.426800|
...
| Positives |1881|1975|
| Parallel query wall ms |96.829900|88.839300|
