...
| Metric | Value |
|---|---:|
| Reference pool build ms |2444.699300|
| Reference import ms |60.878900|
| Analyzed primitive BVH build ms |95.807800|
| Primitive BVH cache hits |13|
| Primitive BVH cache misses |0|
| Primitive BVH cache load ms |4.416300|
| Primitive BVH uncached build ms |0.000000|
| Primitive BVH cache save ms |0.000000|
| Install into PQSS ModelPool ms |5.269200|
...
| Positives |1881|1975|
| Parallel query wall ms |96.142800|89.477400|
