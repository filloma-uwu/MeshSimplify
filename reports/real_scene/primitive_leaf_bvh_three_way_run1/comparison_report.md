...
| Metric | Value |
|---|---:|
| Original pool build ms |2486.854500|
| Official simplified pool build ms |388.510100|
| Reference import ms |62.047500|
| Analyzed primitive BVH build ms |95.856100|
| Primitive BVH cache hits |13|
| Primitive BVH cache misses |0|
| Primitive BVH cache load ms |4.502100|
| Primitive BVH uncached build ms |0.000000|
| Primitive BVH cache save ms |0.000000|
| Install into PQSS ModelPool ms |5.285000|
...
| Parallel query wall ms |95.869200|92.836300|90.888900|
