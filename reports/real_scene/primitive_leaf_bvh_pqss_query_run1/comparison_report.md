...
| Metric | Value |
|---|---:|
| Reference pool build ms |2424.086100|
| Reference import ms |62.237000|
| Analyzed primitive BVH build ms |96.570800|
| Primitive BVH cache hits |13|
| Primitive BVH cache misses |0|
| Primitive BVH cache load ms |4.534200|
| Primitive BVH uncached build ms |0.000000|
| Primitive BVH cache save ms |0.000000|
| Install into PQSS ModelPool ms |5.273300|
...
| Positives |1881|1975|
| Parallel query wall ms |95.081900|89.945700|
