...
| Metric | Value |
|---|---:|
| Original pool build ms |2508.755100|
| Official simplified pool build ms |392.823300|
| Reference import ms |65.506100|
| Analyzed primitive BVH build ms |95.931300|
| Primitive BVH cache hits |13|
| Primitive BVH cache misses |0|
| Primitive BVH cache load ms |4.686800|
| Primitive BVH uncached build ms |0.000000|
| Primitive BVH cache save ms |0.000000|
| Install into PQSS ModelPool ms |5.349200|
...
| Parallel query wall ms |95.561400|94.444500|88.496100|
